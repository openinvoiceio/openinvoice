...
test.describe("Create product", () => {
    test.beforeEach(async ({page, setupAccount}) => {
        ...
        await page.locator("header").getByRole("button", {name: "Add product"}).click();
    })
    ...
    test("Create customer with all filled fields", async ({page}) => {
        ...
        await page.getByLabel("Description").fill("This is a sample product description.");
