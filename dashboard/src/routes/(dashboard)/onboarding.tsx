          ...
          <main className="w-full flex-1">
            <SectionGroup>
              ...
              <Section>
                <SectionHeader>
                  <SectionDescription className="tabular-nums">
                    Step <span className="text-foreground font-medium">1</span>{" "}
                    of <span className="text-foreground font-medium">2</span>
                  </SectionDescription>
                </SectionHeader>
              ...
              <Section>
                <SectionHeader>
                  <SectionDescription className="tabular-nums">
                    Step <span className="text-foreground font-medium">2</span>{" "}
                    of <span className="text-foreground font-medium">2</span>
                  </SectionDescription>
                </SectionHeader>
                {!customers.isLoading && (
