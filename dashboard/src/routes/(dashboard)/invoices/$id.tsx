          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            {invoice.status === "draft" && (
              <Button
                ...
                variant="outline"
                size="sm"
                onClick={() => finalizeInvoice.mutateAsync({ id: invoice.id })}
        ...
        <SectionGroup className="w-full flex-1">
          <Section>
            <SectionHeader>
              ...
              <SectionDescription>
                <span>Billed to </span>
                <Link to="/customers/$id" params={{ id: invoice.customer.id }}>
              ...
              <TableFooter className="[&_tr]:border-0">
                <TableRow>
                  ...
                  <TableCell className="text-right font-medium">
                    {formatAmount(invoice.subtotal_amount, invoice.currency)}
                  </TableCell>
            ...
            {payments?.data && payments.data.count > 0 ? (
              ...
              <Empty className="border">
                <EmptyHeader>
                  ...
                  <EmptyDescription>
                    Payment will appear here when recorded against this invoice.
                  </EmptyDescription>
                </EmptyHeader>
