    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("tax_ids", models.ManyToManyField(related_name="billing_profiles", to="tax_ids.taxid")),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="billing_profiles", through="customers.BillingProfileTaxRate", to="tax_rates.taxrate"
            ),
        ),
        migrations.CreateModel(
            name="Customer",
            fields=[
                ...
                ("billing_profiles", models.ManyToManyField(related_name="customers", to="customers.billingprofile")),
                (
                    "default_billing_profile",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.PROTECT, related_name="+", to="customers.billingprofile"
                    ),
                ),
            ],
            options={
