...
from .views import (
    QuoteAcceptAPIView,
    QuoteCancelAPIView,
    QuoteCommentDestroyAPIView,
    QuoteCommentsListCreateAPIView,
...
urlpatterns = [
    ...
    path("quotes/<uuid:quote_id>/comments", QuoteCommentsListCreateAPIView.as_view()),
    path("quotes/<uuid:quote_id>/comments/<uuid:pk>", QuoteCommentDestroyAPIView.as_view()),
