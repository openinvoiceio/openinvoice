    ...
    def get_queryset(self):
        return (
            ...
            .select_related(
                ...
                "customer",
                "account",
                "invoice__billing_profile",
                "invoice__billing_profile__address",
                "invoice__business_profile",
                "invoice__business_profile__address",
                "customer__logo",
                "account__logo",
            )
            .prefetch_related(
                "invoice__billing_profile__tax_ids",
                "invoice__business_profile__tax_ids",
                Prefetch(
                    "lines",
