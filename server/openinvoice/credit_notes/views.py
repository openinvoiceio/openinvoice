    ...
    def get_queryset(self):
        return (
            ...
            .select_related(
                ...
                "customer",
                "account",
                "invoice__invoice_customer",
                "invoice__invoice_customer__address",
                "invoice__invoice_customer__logo",
                "invoice__invoice_account",
                "invoice__invoice_account__address",
                "invoice__invoice_account__logo",
                "customer__address",
            ...
            .prefetch_related(
                "customer__tax_ids",
                "account__tax_ids",
                "invoice__invoice_customer__tax_ids",
                "invoice__invoice_account__tax_ids",
                Prefetch(
                    "lines",
