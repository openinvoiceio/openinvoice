...
from openinvoice.integrations.stripe.managers import StripeConnectionManager
from openinvoice.integrations.stripe.querysets import StripeConnectionQuerySet
