...
LOCAL_APPS = [
    "openinvoice.accounts",
    "openinvoice.addresses",
    "openinvoice.analytics",
    "openinvoice.coupons",
    "openinvoice.customers",
    "openinvoice.files",
    "openinvoice.invoices",
    "openinvoice.credit_notes",
    "openinvoice.core",
    "openinvoice.integrations",
    "openinvoice.integrations.stripe",
    "openinvoice.comments",
    "openinvoice.numbering_systems",
    "openinvoice.payments",
    "openinvoice.portal",
    "openinvoice.quotes",
    "openinvoice.prices",
    "openinvoice.products",
    "openinvoice.search",
    "openinvoice.shipping_rates",
    "openinvoice.stripe",
    "openinvoice.tax_ids",
    "openinvoice.tax_rates",
    "openinvoice.users",
]
